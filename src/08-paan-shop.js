...
export function updatePrices(menu, increase) {
  ...
  for(const [key,value] of Object.entries(menu)){
    updatedObject[key] = value + increase;
  }
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  ...
  if((typeof regularMenu != 'object' || regularMenu==null) && (typeof specialsMenu != 'object' || specialsMenu==null)){
    return {};
  }

  let result = {...regularMenu, ...specialsMenu};
  return result;
}
